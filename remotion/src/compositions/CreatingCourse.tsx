...
export const CreatingCourse: React.FC = () => {
  return (
    <AbsoluteFill>
      ...
      {/* 4-12s: Courses page — highlight + New Course button */}
      ...
      {/* 12-21s: New Course dialog — top fields */}
      ...
      {/* 21-30s: New Course dialog — bottom fields */}
      ...
      {/* 30-38s: Expanded course showing modules */}
